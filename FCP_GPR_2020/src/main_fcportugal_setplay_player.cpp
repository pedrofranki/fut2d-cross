...
// Must be initialized inside main, or else Boost Spirit (used in FCPortugal Setplays) was malfunctioning
FCPortugalSetplayPlayer* agentPtr=NULL;
...
main( int argc, char **argv )
{
	...
	FCPortugalSetplayPlayer agent(true);
	agentPtr=&agent;
     ...
     */
     std::cout << "*****************************************************************\n"
               << " This program was modified by FCPortugal\n"
               << " Copyright 2014. Luís Mota.\n"
               << " All rights reserved.\n"
               << "*****************************************************************\n"
               << std::flush;
